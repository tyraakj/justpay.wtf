    ...
    <div className="w-full max-w-7xl mx-auto px-6 py-24 relative z-20">
      <div className="flex flex-col gap-16">
        <div className="flex flex-col gap-4 text-center items-center">
          ...
          <p className="text-xl text-gray-400 max-w-2xl">Three simple steps to unified payments. No complex integrations required.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          
          {/* Step 1 */}
          <div className="flex flex-col gap-8 group bg-[#0A0A0A]/50 p-8 rounded-[2rem] border border-white/5 hover:bg-[#0A0A0A] hover:border-white/10 transition-colors">
            <div className="flex flex-col gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white mb-3">Generate Link</h3>
            ...
            {/* Mini Demo Segment */}
            <div className="mt-auto bg-[#050505] border border-white/5 rounded-2xl p-5 flex flex-col gap-4 shadow-inner">
              ...
              <div className="text-3xl font-bold text-white">500.00</div>
          ...
          <div className="flex flex-col gap-8 group bg-[#0A0A0A]/50 p-8 rounded-[2rem] border border-white/5 hover:bg-[#0A0A0A] hover:border-white/10 transition-colors">
            <div className="flex flex-col gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white mb-3">Share Anywhere</h3>
                <p className="text-base text-gray-400 leading-relaxed">
